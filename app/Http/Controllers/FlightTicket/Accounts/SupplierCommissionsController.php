...
use App\Models\FlightTicket\Accounts\SupplierCommission;
...
class SupplierCommissionsController extends Controller
{

    public function __construct() {
        $this->middleware('permission:supplier_commission show', ['only' => ['index']]);
    }
    ...
    public function index(Request $request)
    {
        ...
        $q = SupplierCommission::orderby('created_at','DESC');

        if($request->has('agent_id') && $request->agent_id  != '') {
            $agent = Owner::find($request->agent_id);
            $q     = $q->where('supplier_id', $request->agent_id);
        }
        ...
        return view('accounts.supplier_commissions.index',compact('agent','datas'));
    }
    ...
    public function create()
    {
        ...
        return view('accounts.supplier_commissions.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $resp = SupplierCommission::create($data);
        ...
        return redirect(route('supplier-commissions.index'));
    }
