...
class ReceiptController extends Controller
{
    ...
    public function index(Request  $request)
    {
        ...
        if($request->has('start_date') && $request->has('end_date')){
            ...
            if($start_date->format('Y-m-d') <= '2023-03-31' ||
                ...
                $datas = collect([]);
                return view('accounts.receipts.index',compact('agents','datas','agent'));
            }
        }else{
    ...
    public function create()
    {
        ...
        return view('accounts.receipts.create',compact('agents','bank_details'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $new_balance = $old_balance + (float)$request->amount;
        ...
        try {
            ...
            DB::select("CALL prc_opt_reclaculate_agent_data($request->agent_id,'".$date."' )");

            $data['account_transaction_id'] = $creditResp->id;
            Receipt::create($data);
            AgentService::updateOpeningBalance($request->agent_id,1, $request->amount);
            ...
            return  redirect(route('agent-receipts.index'));
    ...
    public function show($id)
    {
        ...
        return view('accounts.receipts.show',compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        // return view('accounts.receipts.edit',compact('agents','bank_details','receipts'));
    }
