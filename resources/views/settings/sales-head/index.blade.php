...
<div class="col-12 grid-margin">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <h4 class="card-title text-uppercase">Sales Head</h4>
                    <p class="card-description">Sales Heads in the Appication.</p>
                </div>
                <div class="col-md-6 text-right">
                    <a href="/settings/sales-head/create" class="btn btn-sm btn-primary">New Sales Head</a>
                </div>
            </div>
                ...
                <div class="table-sorter-wrapper col-lg-12 table-responsive">
                    <table id="sortable-table-2" class="table table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            @foreach($salesHead as $key => $value)
                            <tr>
                                <td>{{ 1 + $key }}</td>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="/settings/sales-head/edit/{{$value->id}}" class="btn btn-success btn-xs">Edit</a>
                                    </div>
                                </td>
                    ...
                    {{ $salesHead->appends(request()->input())->links() }}
                </div>
            </div>
        </div>
    </div>
