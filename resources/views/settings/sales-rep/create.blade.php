...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title text-uppercase"> New Sales Rep</h4>
            <p class="card-description">
                Register a new Sales Rep to the application
            </p>

            <form class="forms-sample" method="POST" action="/settings/sales-rep/store">
                @csrf
                <div class="form-group row">
                    <label for="status" class="col-sm-3 col-form-label">Sales Head</label>
                    <div class="col-sm-9">
                        <select name="sales_head_id" id="sales_head_id" class="form-control">
