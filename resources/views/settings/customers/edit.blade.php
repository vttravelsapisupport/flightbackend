...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title text-uppercase">Customer Details</h4>
            <p class="card-description">
                Customer  Details of <strong> {{ $data->company_name }}</strong>
            </p>
                                ...
                                <td>
                                    ...
                                    <select  name="type" id="" class="form-control form-control-sm">
                                        @foreach(CustomerTypeEnum::cases() as $c)
                                         <option value="{{$c->value}}" @if(CustomerTypeEnum::tryFrom($data->type) == $c) selected @endif>{{ $c->getDisplayName()}}</option>
                                        @endforeach
                                </select>
                                </td>
                            </tr>
                    ...
                    <div class="col-md-6">
                        <table class="table table-sm mt-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="status" id="status" class="form-control form-control-sm" required>
                                        ...
                                        <option value="2" @if(2==$data->status) selected @endif>Dormant</option>
                                        <option value="3" @if(3==$data->status) selected @endif>Duplicate</option>
                                        <option value="4" @if(4==$data->status) selected @endif>B2C</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Remarks</th>
                                <td>
                                    <input type="text" class="form-control form-control-sm" name="remarks" value="{{ $data->remarks }}">
                                </td>
                            </tr>
                            <tr class="table-warning">
