...
<div class="col-12 grid-margin">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <h4 class="card-title text-uppercase">Distributors</h4>
                    <p class="card-description">Distributors in the Appication.</p>
                </div>
                <div class="col-md-6 text-right">
                    @can('agent create')
                    <a href="{{ route('agents.create') }}" class="btn btn-sm btn-primary">Register Distributor</a>
                    @endcan
                            ...
                            <tr @if($value->gst_no) class="table-success" @elseif($value->status == 0) class="table-danger" @endif>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        @endif
                                        @can('agent show')
                                            <a href="{{ route('distributors.show',$value->id) }}" class="btn btn-outline-secondary btn-sm">View</a>
                                        @endcan
                                        @can('agent update')
                                         <a href="{{ route('distributors.edit',$value->id) }}" class="btn btn-outline-warning btn-sm">Edit</a>
                                        @endcan
                                        @can('agent delete')
