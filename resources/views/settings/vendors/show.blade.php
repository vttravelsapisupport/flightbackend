    ...
    <div class="card">
        <div class="card-body">
            ...
            <table class="table table-sm table-condensed">
                ...
                <tbody>
                    @foreach($opening_balances as $i => $d)
                    <tr >
                        <td> {{  1 + $i }}</td>
                        <td> {{ $d->Fy->name }} </td>
                        <td> @money($d->amount)</td>
                        <td>
                            <a href="{{route('vendors.fyShowEdit', ['id' => $d->supplier_id, 'fy_id' =>  $d->fys_id ])}}">Edit</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<script>
    $('#newAccountRegistration').submit(function(e) {
        ...
        $.ajax({
            url :'/accounts/supplier-bank-details',
            type: 'POST',
            data: data,
