    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample row" method="GET" action="">
                <div class="col-md-2">
                    <input type="text" class="form-control form-control-sm form-control form-control-sm-sm" name="bill_no" placeholder="Enter the Bill No" value="{{ request()->query('bill_no') }}">
                </div>
                <div class="col-md-2">
...
<script>
    $(document).ready(function() {
        ...
        $('.btn-delete-refund').click(function(e) {
            ...
            window.location.href = "/maintanance/manage-refund-details/" + id + "/" + ticket_id + "/" + created_at;
