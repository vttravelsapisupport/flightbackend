            ...
            <form action="{{ route('book-ticket.store') }}" method="POST">
                ...
                <div class="form-group row">
                    <div class="col-md-6 form-group ">
                        ...
                        <textarea name="infant_detail" id="infant_detail" cols="30" rows="2" class="form-control form-control-sm">
                                 </textarea>
                    ...
                    <div class=" col-md-6">
                        ...
                        <div class="form-group ">
                            ...
                            <textarea name="remarks" id="remarks" cols="20" rows="2" class="form-control form-control-sm">
