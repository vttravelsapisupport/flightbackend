                                        ...
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td class="text-right font-md">
                                                    <p class="text-uppercase text-primary">{{ $data->agent->company_name}} </p>
                                                    Booking ID : {{ $data->bill_no}} <br> Booked on : {{ $data->created_at->format('d-m-Y H:i:s ') }}
                                                </td>
                                            </tr>
                                        </table>
                                        <!-- Header Info -->
                                        ...
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="py-1">
                                            <tr>
                                                <td valign="middle" width="180">
                                                    <img src="{{ $data->purchase_entry->airline->description }}" width="150" class="img-responsive" alt="">
                                                </td>
                                                <td valign="middle">
                                                    <p class="mb-0">{{ $data->purchase_entry->airline->name }}</p>
                                                    <p class="text-primary"><strong>{{ $data->purchase_entry->airline->helpline_no }}</strong></p>
                                                </td>
                                                <td valign="middle">
                                                    <p class="mb-0">Agency</p>
                                                    <p class="text-primary"><strong>{{ $data->agent->phone}}</strong></p>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="border border-primary">
                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td class="py-05 px-2">
                                                                {{ $data->airlineDetails }}<br>
                                                                {{ $data->purchase_entry->flight_no }}
                                                            </td>
                                                            <td class="py-05 px-2">
