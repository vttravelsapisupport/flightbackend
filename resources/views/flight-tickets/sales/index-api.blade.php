        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample row" method="GET" action="">
                    ...
                    <div class="col-md-2">
                        <input type="text" class="form-control form-control-sm form-control" name="bill_no" placeholder="Enter the Bill No" autocomplete="off" value="{{ request()->query('bill_no') }}">
                    </div>
                    ...
                    <div class="col-md-2">
                        <select name="source" id="source" class="form-control form-control-sm">
                            ...
                            <option value="admin" @if ('admin' == request()->query('source')) selected @endif>Admin
                            </option>
                            <option value="portal" @if ('portal' == request()->query('source')) selected @endif>Portal
                            </option>
                            <option value="api" @if ('api' == request()->query('source')) selected @endif>API
                            </option>
                        </select>
                    </div>
                ...
                <div class="mt-2">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        @can('refund create')
                            <a href="javascript:void(0)" class="btn btn-outline-success btn-sm" id="refundAnchor">Refund</a>
                        @endcan

                        @can('sale-ticket services')
                            <a href="javascript:void(0)" class="btn btn-warning btn-sm" id="servicesButton">Services</a>
                        @endcan
                        @can('sale-ticket intimation')
                            <a href="javascript:void(0)" class="btn btn-outline-success btn-sm" id="IntimateAnchor">Intimation</a>
                        @endcan
                        @can('sale-ticket delete')
                            <a href="javascript:void(0)" class="btn btn-danger btn-sm" id="btnDelete">Delete</a>
                        @endcan
                    </div>
                </div>
                <div class="row mt-3">
