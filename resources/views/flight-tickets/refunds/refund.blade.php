...
@section('contents')
    <div class=" col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title text-uppercase">Refund Ticket</h4>
                <p class="card-description">
                    Refund Ticket
                </p>
                <hr>

                <form action="{{ url('/flight-tickets/refund-booking/refund') }}" method="POST">
                    @csrf
                    <input type="hidden" name="ticket_id" value="{{ $data->id }}">
                    @if($data->purchase_entry->airline_id == 3)
                    <div class="alert alert-warning" role="alert">
                        Refund of this will be added to the Credit Shell of the agent.
                    </div>
                    @endif
                    ...
                    <table class="table table-sm table-bordered text-center" style="opacity: 0.7; pointer-events: none;">
                        ...
                        @foreach($data->passenger_details as $key => $value)
                            <tr class="@if($value->is_refund == 1) bg-red @endif">
                                <td>
                                    <input type="checkbox" value="{{ $value->id }}" name="refund[]" class="@if($value->is_refund != 1 && $value->type == 1 )refund_ids @endif @if($value->is_refund != 1 && $value->type == 2 )refund_ids_child @endif @if($value->is_refund != 1 && $value->type == 3 )refund_ids_infant @endif" @if($value->is_refund == 1) checked @endif
                                    @if($value->is_refund == 1)disabled @endif
                                    @if(in_array($value->id , $passenger_ids))checked @endif
                                    >
                                </td>
                                <td>{{ $value->title }} </td>
                    ...
                    <div class="form-group row">
                        ...
                        <div class=" col-md-12">
                            ...
                            <textarea name="remarks" id="remarks" cols="20" rows="2" class="form-control form-control-sm" required="required"></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="hidden" name="cancel_id" value="{{$_GET['cancel_request_id']}}">
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control form-control-sm" step="0.01" value="0" name="refund_pax_price" aria-invalid="refund_pax_price" id="refund_pax_price">
                                </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 text-right">
                            <button type="submit" class="btn btn-success btn-sm">Refund Now</button>
