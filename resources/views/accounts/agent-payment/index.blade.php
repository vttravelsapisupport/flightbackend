    ...
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title text-uppercase">Agent Payments</h4>
                        <p class="card-description">All Agent Payments in the Application.</p>
                    </div>
                    <div class="col-md-6 text-right">
                        <a href="{{ route('agent-payments.create') }}" class="btn btn-sm btn-primary">New Payment</a>
                    </div>
                </div>
                <form action="">
                    <div class="row mb-3">
                                ...
                                @if ($datas->count() > 0)
                                    @foreach ($datas as $key => $val)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('agent-payments.show', $val->id) }}"
                                                    class="btn btn-sm btn-success">View</a>
                                                {{-- <a href="{{ route('agent-payments.edit', $val->id) }}"--}}
