...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample row" method="POST" action="{{ route('agent-notification.store') }}">
                @csrf
                <div class="col-md-6">
                    <div class="form-group row">
                        <label for="company_name" class="col-sm-3 col-form-label">Title</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="title" placeholder="Enter the title of the notification" name="title" value="{{ old('title') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="body" class="col-sm-3 col-form-label">Body</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="body" placeholder="Enter the body of the notification" name="body" value="{{ old('body') }}" required>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="notification_type" id="notification_type" class="form-control">
                                ...
                                <option value="1">Landing Page Notification</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row agentsDiv" style="display:none">
                        <label for="email" class="col-sm-3 col-form-label">Agents</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row sectorDiv" style="display:none">
                        <label for="email" class="col-sm-3 col-form-label">Sector Level</label>
                        <div class="col-sm-9">
                            <select name="sector[]" id="sector" class="form-control" multiple>
