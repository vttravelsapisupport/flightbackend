...
gulp.task('copyAddonsScripts', function() {
    ...
    var aScript21 = gulp.src(['./node_modules/jquery.flot/jquery.flot.js'])
        .pipe(gulp.dest('./vendors/jquery.flot'));
    var aScript22 = gulp.src(['./node_modules/jquery.flot/jquery.flot.crosshair.js'])
        .pipe(gulp.dest('./vendors/jquery.flot'));
    var aScript23 = gulp.src(['./node_modules/jquery.flot/jquery.flot.pie.js'])
        .pipe(gulp.dest('./vendors/jquery.flot'));
    var aScript24 = gulp.src(['./node_modules/jquery.flot/jquery.flot.resize.js'])
        .pipe(gulp.dest('./vendors/jquery.flot'));
    var aScript25 = gulp.src(['./node_modules/jqvmap/dist/jquery.vmap.min.js'])
        .pipe(gulp.dest('./vendors/jqvmap'));
    var aScript26 = gulp.src(['./node_modules/jqvmap/dist/maps/**/*'])
        .pipe(gulp.dest('./vendors/jqvmap/maps'));
    ...
    var aScript75 = gulp.src(['./node_modules/peity/jquery.peity.min.js'])
        .pipe(gulp.dest('./vendors/peity'));
    var aScript76 = gulp.src(['node_modules/inputmask/dist/jquery.inputmask.bundle.js'])
        .pipe(gulp.dest('./vendors/inputmask'));
    var aScript77 = gulp.src(['node_modules/progressbar.js/dist/progressbar.min.js'])
        .pipe(gulp.dest('./vendors/progressbar.js'));
...
gulp.task('copyAddonsStyles', function() {
    ...
    var aStyle52 = gulp.src(['node_modules/ion-rangeslider/img/*'])
        .pipe(gulp.dest('./vendors/ion-rangeslider/img'));
    var aStyle53 = gulp.src(['node_modules/dropzone/dist/dropzone.css'])
        .pipe(gulp.dest('./vendors/dropzone'));
    var aStyle54 = gulp.src(['node_modules/pwstabs/assets/jquery.pwstabs.min.css'])
        .pipe(gulp.dest('./vendors/pwstabs'));
    var aStyle55 = gulp.src(['node_modules/jqvmap/dist/jqvmap.min.css'])
        .pipe(gulp.dest('./vendors/jqvmap'));
